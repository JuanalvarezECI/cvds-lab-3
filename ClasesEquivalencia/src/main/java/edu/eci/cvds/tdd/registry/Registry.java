...
public class Registry {
    ...
    public RegisterResult registerVoter(Person p) {
        ...
        result = (result == isValid) ? isDeadPerson(isAlive): result;
...
private RegisterResult isDeadPerson(boolean isAlive) {
        return (!isAlive ) ? RegisterResult.DEAD : RegisterResult.VALID;
        }
